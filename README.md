...
To test the application locally or in production, you can use the following credentials:

| Type | Email | Password / OTP Code |
| :--- | :--- | :--- |
| 🛡️ **Demo Account** | `admin@ecosphere.com` | `12345` *(bypasses email OTP)* |